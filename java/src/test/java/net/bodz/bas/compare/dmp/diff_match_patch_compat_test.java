...
public class diff_match_patch_compat_test {
    ...
    public static void testDiffLinesToChars() {
        ...
        assertLinesToCharsResultEquals("diff_linesToChars: Shared lines.",
                new _LinesToCharsResult("\u0001\u0002\u0001", "\u0002\u0001\u0002", tmpVector),
        ...
        assertLinesToCharsResultEquals("diff_linesToChars: No linebreaks.",
                new _LinesToCharsResult("\u0001", "\u0002", tmpVector), dmp.diff_linesToChars("a", "b"));
        ...
        assertLinesToCharsResultEquals("diff_linesToChars: More than 256.",
                new _LinesToCharsResult(chars, "", tmpVector), dmp.diff_linesToChars(lines, ""));
    }

    public static void testDiffCharsToLines() {
        // First check that Diff equality works.
        assertTrue("diff_charsToLines: Equality #1.", new _Diff(EQUAL, "a").equals(new _Diff(EQUAL, "a")));

        assertEquals("diff_charsToLines: Equality #2.", new _Diff(EQUAL, "a"), new _Diff(EQUAL, "a"));

        // Convert chars up to lines.
        LinkedList<_Diff> diffs = diffList(new _Diff(EQUAL, "\u0001\u0002\u0001"),
                new _Diff(INSERT, "\u0002\u0001\u0002"));
        ArrayList<String> tmpVector = new ArrayList<String>();
        tmpVector.add("");
        tmpVector.add("alpha\n");
        ...
        assertEquals("diff_charsToLines: Shared lines.",
                diffList(new _Diff(EQUAL, "alpha\nbeta\nalpha\n"), new _Diff(INSERT, "beta\nalpha\nbeta\n")), diffs);
        ...
        tmpVector.add(0, "");
        diffs = diffList(new _Diff(DELETE, chars));
        dmp.diff_charsToLines(diffs, tmpVector);
        assertEquals("diff_charsToLines: More than 256.", diffList(new _Diff(DELETE, lines)), diffs);
        ...
        _LinesToCharsResult results = dmp.diff_linesToChars(chars, "");
        diffs = diffList(new _Diff(INSERT, results.chars1));
    ...
    public static void testDiffCleanupMerge() {
        ...
        diffs = diffList(new _Diff(EQUAL, "a"), new _Diff(DELETE, "b"), new _Diff(INSERT, "c"));
        dmp.diff_cleanupMerge(diffs);
        assertEquals("diff_cleanupMerge: No change case.",
                diffList(new _Diff(EQUAL, "a"), new _Diff(DELETE, "b"), new _Diff(INSERT, "c")), diffs);

        diffs = diffList(new _Diff(EQUAL, "a"), new _Diff(EQUAL, "b"), new _Diff(EQUAL, "c"));
        dmp.diff_cleanupMerge(diffs);
        assertEquals("diff_cleanupMerge: Merge equalities.", diffList(new _Diff(EQUAL, "abc")), diffs);

        diffs = diffList(new _Diff(DELETE, "a"), new _Diff(DELETE, "b"), new _Diff(DELETE, "c"));
        dmp.diff_cleanupMerge(diffs);
        assertEquals("diff_cleanupMerge: Merge deletions.", diffList(new _Diff(DELETE, "abc")), diffs);

        diffs = diffList(new _Diff(INSERT, "a"), new _Diff(INSERT, "b"), new _Diff(INSERT, "c"));
        dmp.diff_cleanupMerge(diffs);
        assertEquals("diff_cleanupMerge: Merge insertions.", diffList(new _Diff(INSERT, "abc")), diffs);

        diffs = diffList(new _Diff(DELETE, "a"), new _Diff(INSERT, "b"), new _Diff(DELETE, "c"), new _Diff(INSERT, "d"),
                new _Diff(EQUAL, "e"), new _Diff(EQUAL, "f"));
        dmp.diff_cleanupMerge(diffs);
        assertEquals("diff_cleanupMerge: Merge interweave.",
                diffList(new _Diff(DELETE, "ac"), new _Diff(INSERT, "bd"), new _Diff(EQUAL, "ef")), diffs);

        diffs = diffList(new _Diff(DELETE, "a"), new _Diff(INSERT, "abc"), new _Diff(DELETE, "dc"));
        dmp.diff_cleanupMerge(diffs);
        assertEquals("diff_cleanupMerge: Prefix and suffix detection.",
                diffList(new _Diff(EQUAL, "a"), new _Diff(DELETE, "d"), new _Diff(INSERT, "b"), new _Diff(EQUAL, "c")),
                diffs);

        diffs = diffList(new _Diff(EQUAL, "x"), new _Diff(DELETE, "a"), new _Diff(INSERT, "abc"),
                new _Diff(DELETE, "dc"), new _Diff(EQUAL, "y"));
        dmp.diff_cleanupMerge(diffs);
        assertEquals("diff_cleanupMerge: Prefix and suffix detection with equalities.", diffList(new _Diff(EQUAL, "xa"),
                new _Diff(DELETE, "d"), new _Diff(INSERT, "b"), new _Diff(EQUAL, "cy")), diffs);

        diffs = diffList(new _Diff(EQUAL, "a"), new _Diff(INSERT, "ba"), new _Diff(EQUAL, "c"));
        dmp.diff_cleanupMerge(diffs);
        assertEquals("diff_cleanupMerge: Slide edit left.", diffList(new _Diff(INSERT, "ab"), new _Diff(EQUAL, "ac")),
                diffs);

        diffs = diffList(new _Diff(EQUAL, "c"), new _Diff(INSERT, "ab"), new _Diff(EQUAL, "a"));
        dmp.diff_cleanupMerge(diffs);
        assertEquals("diff_cleanupMerge: Slide edit right.", diffList(new _Diff(EQUAL, "ca"), new _Diff(INSERT, "ba")),
                diffs);

        diffs = diffList(new _Diff(EQUAL, "a"), new _Diff(DELETE, "b"), new _Diff(EQUAL, "c"), new _Diff(DELETE, "ac"),
                new _Diff(EQUAL, "x"));
        dmp.diff_cleanupMerge(diffs);
        assertEquals("diff_cleanupMerge: Slide edit left recursive.",
                diffList(new _Diff(DELETE, "abc"), new _Diff(EQUAL, "acx")), diffs);

        diffs = diffList(new _Diff(EQUAL, "x"), new _Diff(DELETE, "ca"), new _Diff(EQUAL, "c"), new _Diff(DELETE, "b"),
                new _Diff(EQUAL, "a"));
        dmp.diff_cleanupMerge(diffs);
        assertEquals("diff_cleanupMerge: Slide edit right recursive.",
                diffList(new _Diff(EQUAL, "xca"), new _Diff(DELETE, "cba")), diffs);

        diffs = diffList(new _Diff(DELETE, "b"), new _Diff(INSERT, "ab"), new _Diff(EQUAL, "c"));
        dmp.diff_cleanupMerge(diffs);
        assertEquals("diff_cleanupMerge: Empty merge.", diffList(new _Diff(INSERT, "a"), new _Diff(EQUAL, "bc")),
                diffs);

        diffs = diffList(new _Diff(EQUAL, ""), new _Diff(INSERT, "a"), new _Diff(EQUAL, "b"));
        dmp.diff_cleanupMerge(diffs);
        assertEquals("diff_cleanupMerge: Empty equality.", diffList(new _Diff(INSERT, "a"), new _Diff(EQUAL, "b")),
                diffs);
    }
    ...
    public static void testDiffCleanupSemanticLossless() {
        ...
        diffs = diffList(new _Diff(EQUAL, "AAA\r\n\r\nBBB"), new _Diff(INSERT, "\r\nDDD\r\n\r\nBBB"),
                new _Diff(EQUAL, "\r\nEEE"));
        dmp.diff_cleanupSemanticLossless(diffs);
        assertEquals("diff_cleanupSemanticLossless: Blank lines.", diffList(new _Diff(EQUAL, "AAA\r\n\r\n"),
                new _Diff(INSERT, "BBB\r\nDDD\r\n\r\n"), new _Diff(EQUAL, "BBB\r\nEEE")), diffs);

        diffs = diffList(new _Diff(EQUAL, "AAA\r\nBBB"), new _Diff(INSERT, " DDD\r\nBBB"), new _Diff(EQUAL, " EEE"));
        dmp.diff_cleanupSemanticLossless(diffs);
        assertEquals("diff_cleanupSemanticLossless: Line boundaries.",
                diffList(new _Diff(EQUAL, "AAA\r\n"), new _Diff(INSERT, "BBB DDD\r\n"), new _Diff(EQUAL, "BBB EEE")),
                diffs);

        diffs = diffList(new _Diff(EQUAL, "The c"), new _Diff(INSERT, "ow and the c"), new _Diff(EQUAL, "at."));
        dmp.diff_cleanupSemanticLossless(diffs);
        assertEquals("diff_cleanupSemanticLossless: Word boundaries.",
                diffList(new _Diff(EQUAL, "The "), new _Diff(INSERT, "cow and the "), new _Diff(EQUAL, "cat.")), diffs);
        ...
        diffs = diffList(new _Diff(EQUAL, "a"), new _Diff(DELETE, "a"), new _Diff(EQUAL, "ax"));
        dmp.diff_cleanupSemanticLossless(diffs);
        assertEquals("diff_cleanupSemanticLossless: Hitting the start.",
                diffList(new _Diff(DELETE, "a"), new _Diff(EQUAL, "aax")), diffs);

        diffs = diffList(new _Diff(EQUAL, "xa"), new _Diff(DELETE, "a"), new _Diff(EQUAL, "a"));
        dmp.diff_cleanupSemanticLossless(diffs);
        assertEquals("diff_cleanupSemanticLossless: Hitting the end.",
                diffList(new _Diff(EQUAL, "xaa"), new _Diff(DELETE, "a")), diffs);

        diffs = diffList(new _Diff(EQUAL, "The xxx. The "), new _Diff(INSERT, "zzz. The "), new _Diff(EQUAL, "yyy."));
        dmp.diff_cleanupSemanticLossless(diffs);
        assertEquals("diff_cleanupSemanticLossless: Sentence boundaries.",
                diffList(new _Diff(EQUAL, "The xxx."), new _Diff(INSERT, " The zzz."), new _Diff(EQUAL, " The yyy.")),
                diffs);
    }
    ...
    public static void testDiffCleanupSemantic() {
        ...
        diffs = diffList(new _Diff(DELETE, "ab"), new _Diff(INSERT, "cd"), new _Diff(EQUAL, "12"),
                new _Diff(DELETE, "e"));
        dmp.diff_cleanupSemantic(diffs);
        assertEquals("diff_cleanupSemantic: No elimination #1.", diffList(new _Diff(DELETE, "ab"),
                new _Diff(INSERT, "cd"), new _Diff(EQUAL, "12"), new _Diff(DELETE, "e")), diffs);

        diffs = diffList(new _Diff(DELETE, "abc"), new _Diff(INSERT, "ABC"), new _Diff(EQUAL, "1234"),
                new _Diff(DELETE, "wxyz"));
        dmp.diff_cleanupSemantic(diffs);
        assertEquals("diff_cleanupSemantic: No elimination #2.", diffList(new _Diff(DELETE, "abc"),
                new _Diff(INSERT, "ABC"), new _Diff(EQUAL, "1234"), new _Diff(DELETE, "wxyz")), diffs);

        diffs = diffList(new _Diff(DELETE, "a"), new _Diff(EQUAL, "b"), new _Diff(DELETE, "c"));
        dmp.diff_cleanupSemantic(diffs);
        assertEquals("diff_cleanupSemantic: Simple elimination.",
                diffList(new _Diff(DELETE, "abc"), new _Diff(INSERT, "b")), diffs);

        diffs = diffList(new _Diff(DELETE, "ab"), new _Diff(EQUAL, "cd"), new _Diff(DELETE, "e"), new _Diff(EQUAL, "f"),
                new _Diff(INSERT, "g"));
        dmp.diff_cleanupSemantic(diffs);
        assertEquals("diff_cleanupSemantic: Backpass elimination.",
                diffList(new _Diff(DELETE, "abcdef"), new _Diff(INSERT, "cdfg")), diffs);

        diffs = diffList(new _Diff(INSERT, "1"), new _Diff(EQUAL, "A"), new _Diff(DELETE, "B"), new _Diff(INSERT, "2"),
                new _Diff(EQUAL, "_"), new _Diff(INSERT, "1"), new _Diff(EQUAL, "A"), new _Diff(DELETE, "B"),
                new _Diff(INSERT, "2"));
        dmp.diff_cleanupSemantic(diffs);
        assertEquals("diff_cleanupSemantic: Multiple elimination.",
                diffList(new _Diff(DELETE, "AB_AB"), new _Diff(INSERT, "1A2_1A2")), diffs);

        diffs = diffList(new _Diff(EQUAL, "The c"), new _Diff(DELETE, "ow and the c"), new _Diff(EQUAL, "at."));
        dmp.diff_cleanupSemantic(diffs);
        assertEquals("diff_cleanupSemantic: Word boundaries.",
                diffList(new _Diff(EQUAL, "The "), new _Diff(DELETE, "cow and the "), new _Diff(EQUAL, "cat.")), diffs);

        diffs = diffList(new _Diff(DELETE, "abcxx"), new _Diff(INSERT, "xxdef"));
        dmp.diff_cleanupSemantic(diffs);
        assertEquals("diff_cleanupSemantic: No overlap elimination.",
                diffList(new _Diff(DELETE, "abcxx"), new _Diff(INSERT, "xxdef")), diffs);

        diffs = diffList(new _Diff(DELETE, "abcxxx"), new _Diff(INSERT, "xxxdef"));
        dmp.diff_cleanupSemantic(diffs);
        assertEquals("diff_cleanupSemantic: Overlap elimination.",
                diffList(new _Diff(DELETE, "abc"), new _Diff(EQUAL, "xxx"), new _Diff(INSERT, "def")), diffs);

        diffs = diffList(new _Diff(DELETE, "xxxabc"), new _Diff(INSERT, "defxxx"));
        dmp.diff_cleanupSemantic(diffs);
        assertEquals("diff_cleanupSemantic: Reverse overlap elimination.",
                diffList(new _Diff(INSERT, "def"), new _Diff(EQUAL, "xxx"), new _Diff(DELETE, "abc")), diffs);

        diffs = diffList(new _Diff(DELETE, "abcd1212"), new _Diff(INSERT, "1212efghi"), new _Diff(EQUAL, "----"),
                new _Diff(DELETE, "A3"), new _Diff(INSERT, "3BC"));
        dmp.diff_cleanupSemantic(diffs);
        assertEquals("diff_cleanupSemantic: Two overlap eliminations.",
                diffList(new _Diff(DELETE, "abcd"), new _Diff(EQUAL, "1212"), new _Diff(INSERT, "efghi"),
                        new _Diff(EQUAL, "----"), new _Diff(DELETE, "A"), new _Diff(EQUAL, "3"),
                        new _Diff(INSERT, "BC")),
                diffs);
    }
    ...
    public static void testDiffCleanupEfficiency() {
        ...
        dmp.diff_cleanupEfficiency(diffs);
        assertEquals("diff_cleanupEfficiency: No elimination.", diffList(new _Diff(DELETE, "ab"),
                new _Diff(INSERT, "12"), new _Diff(EQUAL, "wxyz"), new _Diff(DELETE, "cd"), new _Diff(INSERT, "34")),
                diffs);

        diffs = diffList(new _Diff(DELETE, "ab"), new _Diff(INSERT, "12"), new _Diff(EQUAL, "xyz"),
                new _Diff(DELETE, "cd"), new _Diff(INSERT, "34"));
        dmp.diff_cleanupEfficiency(diffs);
        assertEquals("diff_cleanupEfficiency: Four-edit elimination.",
                diffList(new _Diff(DELETE, "abxyzcd"), new _Diff(INSERT, "12xyz34")), diffs);

        diffs = diffList(new _Diff(INSERT, "12"), new _Diff(EQUAL, "x"), new _Diff(DELETE, "cd"),
                new _Diff(INSERT, "34"));
        dmp.diff_cleanupEfficiency(diffs);
        assertEquals("diff_cleanupEfficiency: Three-edit elimination.",
                diffList(new _Diff(DELETE, "xcd"), new _Diff(INSERT, "12x34")), diffs);

        diffs = diffList(new _Diff(DELETE, "ab"), new _Diff(INSERT, "12"), new _Diff(EQUAL, "xy"),
                new _Diff(INSERT, "34"), new _Diff(EQUAL, "z"), new _Diff(DELETE, "cd"), new _Diff(INSERT, "56"));
        dmp.diff_cleanupEfficiency(diffs);
    ...
    public static void testDiffPrettyHtml() {
        // Pretty print.
        LinkedList<_Diff> diffs = diffList(new _Diff(EQUAL, "a\n"), new _Diff(DELETE, "<B>b</B>"),
                new _Diff(INSERT, "c&d"));
    ...
    public static void testDiffText() {
        ...
        LinkedList<_Diff> diffs = diffList(new _Diff(EQUAL, "jump"), new _Diff(DELETE, "s"), new _Diff(INSERT, "ed"),
                new _Diff(EQUAL, " over "), new _Diff(DELETE, "the"), new _Diff(INSERT, "a"),
                new _Diff(EQUAL, " lazy"));
    ...
    public static void testDiffDelta() {
        ...
        LinkedList<_Diff> diffs = diffList(new _Diff(EQUAL, "jump"), new _Diff(DELETE, "s"), new _Diff(INSERT, "ed"),
                new _Diff(EQUAL, " over "), new _Diff(DELETE, "the"), new _Diff(INSERT, "a"), new _Diff(EQUAL, " lazy"),
                new _Diff(INSERT, "old dog"));
        ...
        diffs = diffList(new _Diff(EQUAL, "\u0680 \000 \t %"), new _Diff(DELETE, "\u0681 \001 \n ^"),
                new _Diff(INSERT, "\u0682 \002 \\ |"));
        ...
        diffs = diffList(new _Diff(INSERT, "A-Z a-z 0-9 - _ . ! ~ * ' ( ) ; / ? : @ & = + $ , # "));
        ...
        diffs = diffList(new _Diff(INSERT, a));
        delta = dmp.diff_toDelta(diffs);
    ...
    public static void testDiffXIndex() {
        ...
        LinkedList<_Diff> diffs = diffList(new _Diff(DELETE, "a"), new _Diff(INSERT, "1234"), new _Diff(EQUAL, "xyz"));
        assertEquals("diff_xIndex: Translation on equality.", 5, dmp.diff_xIndex(diffs, 2));

        diffs = diffList(new _Diff(EQUAL, "a"), new _Diff(DELETE, "1234"), new _Diff(EQUAL, "xyz"));
        assertEquals("diff_xIndex: Translation on deletion.", 1, dmp.diff_xIndex(diffs, 3));
    }

    public static void testDiffLevenshtein() {
        LinkedList<_Diff> diffs = diffList(new _Diff(DELETE, "abc"), new _Diff(INSERT, "1234"),
                new _Diff(EQUAL, "xyz"));
        assertEquals("diff_levenshtein: Levenshtein with trailing equality.", 4, dmp.diff_levenshtein(diffs));

        diffs = diffList(new _Diff(EQUAL, "xyz"), new _Diff(DELETE, "abc"), new _Diff(INSERT, "1234"));
        assertEquals("diff_levenshtein: Levenshtein with leading equality.", 4, dmp.diff_levenshtein(diffs));

        diffs = diffList(new _Diff(DELETE, "abc"), new _Diff(EQUAL, "xyz"), new _Diff(INSERT, "1234"));
    ...
    public static void testDiffBisect() {
        ...
        LinkedList<_Diff> diffs = diffList(new _Diff(DELETE, "c"), new _Diff(INSERT, "m"), new _Diff(EQUAL, "a"),
                new _Diff(DELETE, "t"), new _Diff(INSERT, "p"));
        assertEquals("diff_bisect: Normal.", diffs, dmp.diff_bisect(a, b, Long.MAX_VALUE));

        // Timeout.
        diffs = diffList(new _Diff(DELETE, "cat"), new _Diff(INSERT, "map"));
    ...
    public static void testDiffMain() {
        ...
        diffs = diffList(new _Diff(EQUAL, "abc"));
        assertEquals("diff_main: Equality.", diffs, dmp.diff_main("abc", "abc", false));

        diffs = diffList(new _Diff(EQUAL, "ab"), new _Diff(INSERT, "123"), new _Diff(EQUAL, "c"));
        assertEquals("diff_main: Simple insertion.", diffs, dmp.diff_main("abc", "ab123c", false));

        diffs = diffList(new _Diff(EQUAL, "a"), new _Diff(DELETE, "123"), new _Diff(EQUAL, "bc"));
        assertEquals("diff_main: Simple deletion.", diffs, dmp.diff_main("a123bc", "abc", false));

        diffs = diffList(new _Diff(EQUAL, "a"), new _Diff(INSERT, "123"), new _Diff(EQUAL, "b"),
                new _Diff(INSERT, "456"), new _Diff(EQUAL, "c"));
        assertEquals("diff_main: Two insertions.", diffs, dmp.diff_main("abc", "a123b456c", false));

        diffs = diffList(new _Diff(EQUAL, "a"), new _Diff(DELETE, "123"), new _Diff(EQUAL, "b"),
                new _Diff(DELETE, "456"), new _Diff(EQUAL, "c"));
        ...
        diffs = diffList(new _Diff(DELETE, "Apple"), new _Diff(INSERT, "Banana"), new _Diff(EQUAL, "s are a"),
                new _Diff(INSERT, "lso"), new _Diff(EQUAL, " fruit."));
        assertEquals("diff_main: Simple case #2.", diffs,
                dmp.diff_main("Apples are a fruit.", "Bananas are also fruit.", false));

        diffs = diffList(new _Diff(DELETE, "a"), new _Diff(INSERT, "\u0680"), new _Diff(EQUAL, "x"),
                new _Diff(DELETE, "\t"), new _Diff(INSERT, "\000"));
        assertEquals("diff_main: Simple case #3.", diffs, dmp.diff_main("ax\t", "\u0680x\000", false));

        diffs = diffList(new _Diff(DELETE, "1"), new _Diff(EQUAL, "a"), new _Diff(DELETE, "y"), new _Diff(EQUAL, "b"),
                new _Diff(DELETE, "2"), new _Diff(INSERT, "xab"));
        assertEquals("diff_main: Overlap #1.", diffs, dmp.diff_main("1ayb2", "abxab", false));

        diffs = diffList(new _Diff(INSERT, "xaxcx"), new _Diff(EQUAL, "abc"), new _Diff(DELETE, "y"));
        assertEquals("diff_main: Overlap #2.", diffs, dmp.diff_main("abcy", "xaxcxabc", false));

        diffs = diffList(new _Diff(DELETE, "ABCD"), new _Diff(EQUAL, "a"), new _Diff(DELETE, "="),
                new _Diff(INSERT, "-"), new _Diff(EQUAL, "bcd"), new _Diff(DELETE, "="), new _Diff(INSERT, "-"),
                new _Diff(EQUAL, "efghijklmnopqrs"), new _Diff(DELETE, "EFGHIJKLMNOefg"));
        assertEquals("diff_main: Overlap #3.", diffs,
                dmp.diff_main("ABCDa=bcd=efghijklmnopqrsEFGHIJKLMNOefg", "a-bcd-efghijklmnopqrs", false));

        diffs = diffList(new _Diff(INSERT, " "), new _Diff(EQUAL, "a"), new _Diff(INSERT, "nd"),
                new _Diff(EQUAL, " [[Pennsylvania]]"), new _Diff(DELETE, " and [[New"));
...
//        assertTrue("diff_main: Timeout max.", _dmp.Diff_Timeout * 1000 * 2 > duration);
    ...
    public static void testPatchObj() {
        ...
        p.length1 = 18;
        p.length2 = 17;
        p.diffs = diffList(new _Diff(EQUAL, "jump"), new _Diff(DELETE, "s"), new _Diff(INSERT, "ed"),
                new _Diff(EQUAL, " over "), new _Diff(DELETE, "the"), new _Diff(INSERT, "a"),
                new _Diff(EQUAL, "\nlaz"));
    ...
    public static void testPatchMake() {
        ...
        LinkedList<_Diff> diffs = dmp.diff_main(text1, text2, false);
        ...
        diffs = diffList(new _Diff(DELETE, "`1234567890-=[]\\;',./"), new _Diff(INSERT, "~!@#$%^&*()_+{}|:\"<>?"));
    ...
    private static void assertLinesToCharsResultEquals(String error_msg, _LinesToCharsResult a, _LinesToCharsResult b) {
    ...
    private static String[] diff_rebuildtexts(LinkedList<_Diff> diffs) {
        ...
        for (_Diff myDiff : diffs) {
            if (myDiff.type != DifferenceType.INSERTION) {
                text[0] += myDiff.text;
            }
            if (myDiff.type != DifferenceType.REMOVAL) {
                text[1] += myDiff.text;
            }
        }
        return text;
    ...
    private static LinkedList<_Diff> diffList(_Diff... diffs) {
        return new LinkedList<_Diff>(Arrays.asList(diffs));
    }
