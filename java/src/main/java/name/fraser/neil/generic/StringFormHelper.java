...
public class StringFormHelper
        implements
            ICleanupSemanticScore<Object> {

    @Override
    public int compute(Text<?> one, Text<?> two) {
        String s1 = one.asString();
        String s2 = two.asString();
        return diff_cleanupSemanticScore(s1, s2);
    }
    ...
    public static StringFormHelper INSTANCE = new StringFormHelper();
